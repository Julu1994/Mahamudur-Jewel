        ...
        <div className="about-div">
            <div className="about-left-content">
                <p className="about-left-info">
                    ...
                    course on Python. Since then I stared to switch my career
                    path to programming from business administration which was
                    my academic field. Now I have enough experience and skillls
                    to call myself a full-stack developer.
                </p>
            </div>
